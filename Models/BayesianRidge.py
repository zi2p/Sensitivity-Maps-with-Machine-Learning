...
class BayesianRidgeModel:
    def __init__(self, dataset_path='..\\Data\\dataset.npz', model_name='BayesianRidge'):
...
# bayes_model = BayesianRidgeModel()
# bayes_model.load_data()
# bayes_model.train()
# bayes_model.predict_on_file(
