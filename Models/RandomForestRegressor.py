...
class RandomForestModel:
    def __init__(self, dataset_path='..\\Data\\dataset.npz', model_name='RandomForest', n_estimators=20):
        self.dataset_path = dataset_path
        self.model_name = model_name
        self.n_estimators = n_estimators
        self.model = RandomForestRegressor(n_estimators=n_estimators, n_jobs=-1)
        self.X_train, self.X_test, self.y_train, self.y_test = None, None, None, None
        print(f"Инициализирована модель {model_name} (n_estimators={n_estimators})")
