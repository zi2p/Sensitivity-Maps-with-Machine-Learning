...
class HistGBModel:
    def __init__(self, dataset_path='..\\Data\\dataset.npz', model_name='HistGB', max_iter=100):
        self.dataset_path = dataset_path
        self.model_name = model_name
        self.max_iter = max_iter
        base_model = HistGradientBoostingRegressor(max_iter=max_iter)
        self.model = MultiOutputRegressor(base_model)
        self.X_train, self.X_test, self.y_train, self.y_test = None, None, None, None
        print(f"Инициализирована модель {model_name} (max_iter={max_iter})")
    ...
    def train(self):
        ...
        print("Модель HistGradientBoosting обучена.")
...
# model = HistGBModel(max_iter=1000)
# model.load_data()
# model.train()
